...
import 'package:alconometer/features/auth/app_user.dart';
import 'package:alconometer/features/auth/auth_service.dart';
import 'package:alconometer/services/firestore_database.dart';
...
class FirebaseAuthService implements AuthService {
  ...
  Future<AppUser> signInWithEmailAndPassword({required String email, required String password}) async {
    ...
    Future<AppUser> appUser = FirestoreDatabase(uid: uid).getUser(uid: uid);
    return appUser;
  }
